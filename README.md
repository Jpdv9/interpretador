...
# Proyecto: Intérprete de Lenguaje de Programación
...
## Ejemplos de Uso
- `@sumarDigitos(147)` debe retornar `12`.
- `evaluar @potencia(4, 2)` debe retornar `16`.
- `evaluar @sumaRango(2, 5)` debe retornar `14`.
